...
class _PaymentTypeState extends State<PaymentType> {
  final Set<String> selectedPaymentTypes = {};

  List<MapEntry<String, dynamic>> get filteredCustomerData {
    return customerData.entries
        .where((entry) => selectedPaymentTypes.contains(entry.value['paymentType']))
        .toList();
  }
                    ...
                    child: SingleChildScrollView(
                      child: Wrap(
                        ...
                        children: paymentTypes
                          ...
                          selected:
                          selectedPaymentTypes.contains(paymentType),
                        ...
                        onPressed: () {
                          setState(() {
                             customerData.entries
                                .where((entry) =>
                                selectedPaymentTypes.contains(entry.value['paymentType']))
                                .toList();
                          });
